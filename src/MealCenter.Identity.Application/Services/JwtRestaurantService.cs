...
namespace MealCenter.Identity.Application.Services
{
    public class JwtRestaurantService
    {
        ...
        public JwtRestaurantService(JwtService jwtService, UserManager<IdentityUser> userManager)
        {
            _jwtService = jwtService;
            _userManager = userManager;
        }

        public async Task<string> GetJwtString(IdentityUser identity, Guid restaurantId)
        {
