...
{
    public class RegisterClientIdentityUserCommandHandler : IRequestHandler<RegisterClientIdentityUserCommand, IdentityUser>
    {
        private readonly UserManager<IdentityUser> _userManagar;
        private readonly IMediatorHandler _mediatorHandler;
        public RegisterClientIdentityUserCommandHandler(IMediatorHandler mediatorHandler, UserManager<IdentityUser> userManagar)
        {
            _mediatorHandler = mediatorHandler;
            _userManagar = userManagar;
        }

        public async Task<IdentityUser> Handle(RegisterClientIdentityUserCommand command, CancellationToken cancellationToken)
        {
        ...
        {
            var addToRoleResult = await _userManagar.AddToRoleAsync(identity, UserRoles.CLIENT);
