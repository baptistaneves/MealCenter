...
namespace MealCenter.Catalog.Application.Interfaces
{
    public interface IProductAppService : IDisposable
    {
        ...
        Task Update(ProductViewModel product, CancellationToken cancellationToken);
        ...
        Task UpdateCategory(CategoryViewModel category, CancellationToken cancellationToken);
