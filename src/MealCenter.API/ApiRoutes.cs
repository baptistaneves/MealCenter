...
public class ApiRoutes
{
    ...
    public static class Product
    {
        ...
        public const string RemoveCategory = "remove-category/{id}";
        public const string UpdateProduct = "update-product/{id}";
        public const string UpdateCategory = "update-category/{id}";
